    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, ObjectMapper objectMapper)
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .access(nonFallbackWithRoles("SUPER_ADMIN"))
                        .requestMatchers(HttpMethod.PUT, "/api/service-catalog/**")
                        .access(nonFallbackWithRoles("SUPER_ADMIN"))
                        .requestMatchers(HttpMethod.DELETE, "/api/service-catalog/**")
                        .access(nonFallbackWithRoles("SUPER_ADMIN"))
                        .requestMatchers("/api/import/templates/service-catalog", "/api/import/service-catalog")
                        .access(nonFallbackWithRoles("SUPER_ADMIN"))
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/branch-hours/**")
                        .hasAnyRole("SUPER_ADMIN", "BRANCH_ADMIN", "STAFF", "CUSTOMER")
                        .requestMatchers(HttpMethod.PUT, "/api/branch-hours/current").hasRole("BRANCH_ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/delegations/mine").hasRole("CUSTOMER")
                        .requestMatchers(HttpMethod.PUT, "/api/account/social-profile").hasRole("CUSTOMER")
                        .requestMatchers(HttpMethod.POST, "/api/delegations").hasRole("CUSTOMER")
                        .requestMatchers(HttpMethod.POST, "/api/delegations/*/cancel").hasRole("CUSTOMER")
                        .requestMatchers(HttpMethod.POST, "/api/delegations/verify", "/api/delegations/*/use").hasRole("STAFF")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/service-catalog/*/restore").hasRole("SUPER_ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/service-catalog/**").hasRole("SUPER_ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/service-catalog/**").hasRole("SUPER_ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/tickets/{ticketId}/no-show").hasRole("STAFF")
                        ...
                        .requestMatchers("/api/push/**").hasRole("CUSTOMER")
